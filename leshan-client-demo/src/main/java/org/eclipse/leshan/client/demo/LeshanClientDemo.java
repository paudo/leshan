...
public class LeshanClientDemo {
  ...
  public static void createAndStartClient(String endpoint, String localAddress, int localPort,
      ...
      String serverURI, byte[] pskIdentity, byte[] pskKey, PrivateKey clientPrivateKey,
    ...
    if (needBootstrap) {
      if (pskIdentity != null) {
        ...
        initializer.setInstancesForObject(SECURITY,
            x509Bootstrap(serverURI, clientCertificate.getEncoded(),
      ...
      if (pskIdentity != null) {
        ...
        initializer
            .setInstancesForObject(SECURITY, x509(serverURI, 123, clientCertificate.getEncoded(),
                clientPrivateKey.getEncoded(), serverCertificate.getEncoded()));
        initializer.setInstancesForObject(SERVER, new Server(123, 30, BindingMode.U, false));
      } else {
